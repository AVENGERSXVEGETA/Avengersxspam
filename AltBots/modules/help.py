...
HELP_STRING = f"★ ¹־𝘼𝙑𝙀𝙉𝙂𝙀𝙍𝙎 ✘ 𝙎𝙋𝘼𝙈 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @GOD_OF_ABUSER**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/ITZ_KURUKSHETRA"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/ITZ_KURUKSHETRA")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://graph.org/file/c4d336c6ea9158a0cce2c.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own AVENGERS Bots !! @GOD_OF_ABUSER", cache_time=0, alert=True)
